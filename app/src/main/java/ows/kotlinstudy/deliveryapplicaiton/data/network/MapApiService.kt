package ows.kotlinstudy.deliveryapplicaiton.data.network

import ows.kotlinstudy.deliveryapplicaiton.data.response.address.AddressInfoResponse
import ows.kotlinstudy.deliveryapplicaiton.data.response.search.SearchResponse
import ows.kotlinstudy.deliveryapplicaiton.data.url.Key

...
import ows.kotlinstudy.deliveryapplicaiton.databinding.ViewholderGalleryPhotoItemBinding
import ows.kotlinstudy.deliveryapplicaiton.extensions.load
import ows.kotlinstudy.deliveryapplicaiton.screen.review.gallery.GalleryPhoto
        ...
        fun bindData(data: GalleryPhoto) = with(binding) {
            ...
            checkButton.setImageDrawable(
                ContextCompat.getDrawable(
                    ...
                    else R.drawable.ic_check_disabled
                )
            )
        }
